...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.cha.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.cha.security.DomainUserDetailsService", "createSpringSecurityUser");
