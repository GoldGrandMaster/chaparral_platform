...
import com.cha.domain.UploadStatus;
...
public class AWSS3FileStorageServiceImpl implements AWSS3FileStorageService {
    ...
    private Mono<CompletedPart> uploadPartObject(UploadStatus uploadStatus, ByteBuffer buffer) {
        ...
        System.out.printf("UploadPart - partNumber=%d, contentLength=%d", partNumber, buffer.capacity());
        ...
        return Mono
            ...
            .map(uploadPartResult -> {
                ...
                System.out.printf("UploadPart - complete: part=%d, etag=%s", partNumber, uploadPartResult.eTag());
